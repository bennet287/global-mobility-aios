...
class JurisdictionCoverageEvidenceBatchItemProposal(BaseModel):
    ...
    def require_evidence_operation(self):
        if self.immigration_assessment is None and self.source_certification is None:
            raise ValueError("Each coverage batch item must include an immigration assessment or source certification")
        return self
