...
## Delivery Status — v10.16 (2026-07-14)

Current database migration head: `0031_global_coverage_source_onboarding`.
...
2. Use the v10.16 batch onboarding path to create authorities, official sources, and monitors,
