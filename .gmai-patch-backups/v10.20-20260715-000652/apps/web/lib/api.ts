...
): Promise<{ initial_rule_assertion: InitialRuleAssertion; verified_rule: VerifiedRule }> {
  return request<{ initial_rule_assertion: InitialRuleAssertion; verified_rule: VerifiedRule }>(
