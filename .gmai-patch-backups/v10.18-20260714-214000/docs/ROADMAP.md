...
## Delivery Status — v10.17 (2026-07-14)

Current database migration head: `0031_global_coverage_source_onboarding` (unchanged in v10.17).

- v10.17 adds the first current official-evidence tranche for Austria, Germany, Canada, Australia, and New Zealand, plus offline validation and a PowerShell submission workflow. All ten linked assessment/certification records remain pending for independent review.
...
- Phase 10B now has a prioritized evidence worklist and atomic, idempotent evidence batches
  ...
  requirement. The first five-jurisdiction official-evidence tranche is packaged but remains
  pending independent review and does not change coverage-gate totals until approved.
...
1. Submit and independently review the v10.17 Austria, Germany, Canada, Australia, and New Zealand evidence tranche.
2. Use the v10.15 worklist to prepare the next regional evidence tranches without bulk-inferring jurisdiction relationships.
3. Use the v10.16 batch onboarding path to create authorities, official sources, and monitors,
   then independently certify at least one primary source for every required jurisdiction.
4. Maintain fresh monitors and publish at least one reviewed verified rule for each required
   jurisdiction.
5. Continue expanding the human-published pathway catalogue without claiming complete global
   coverage until every Phase 10B release gate passes.
