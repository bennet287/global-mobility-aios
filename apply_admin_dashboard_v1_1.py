...
FILES = {
    "apps/api/app/routers/operations.py": r'''
...
''',
    ...
    "apps/api/app/routers/dashboard.py": r'''
...
def patch_main() -> None:
    ...
    include_line = 'app.include_router(operations.router, prefix="/api/v1", tags=["operations"])'

    if include_line not in text:
        text = text.rstrip() + "\n" + include_line + "\n"

    main_path.write_text(text, encoding="utf-8")
    print("patched apps/api/app/main.py")
