...
ROUTER_SPECS: tuple[RouterSpec, ...] = (
    ...
    RouterSpec(organization_agents.router, feature="organization-agent-lifecycle"),
    RouterSpec(runtime_economics.router, feature="runtime-economics"),
    RouterSpec(organization_skills.router, feature="organization-skills"),
