...
AGENT_ROLE_CARD_MAP = {
    ...
    "hr_lead_agent": "HR_Lead",
    "culture_recruitment_lead_agent": "Culture_Recruitment_Lead",
    "general_counsel_agent": "General_Counsel",
    "public_policy_compliance_lead_agent": "Public_Policy_Compliance_Lead",
...
AGENT_OUTPUT_SCHEMA = {
    ...
    "hr_lead_agent": {
        "summary": "string",
        "people_assessment": "evidence_complete_for_review | evidence_incomplete",
        "evidence_basis": ["string"],
        "evidence_gaps": ["string"],
        "recommendation": "proceed_to_chro_internal_review | hold_for_evidence_or_risk",
        "dissent": False,
        "dissent_reason": "string | null",
        "material_risks": ["string"],
        "escalation_required": False,
    ...
    "culture_recruitment_lead_agent": {
        "summary": "string",
        "culture_recruitment_assessment": "evidence_complete_for_review | evidence_incomplete",
        "evidence_basis": ["string"],
        "evidence_gaps": ["string"],
        "recommendation": "proceed_to_chro_internal_review | hold_for_evidence_or_risk",
        "dissent": False,
    ...
    "general_counsel_agent": {
        "summary": "string",
        "legal_assessment": "evidence_complete_for_review | evidence_incomplete",
        "evidence_basis": ["string"],
        "evidence_gaps": ["string"],
        "recommendation": "proceed_to_clo_internal_review | hold_for_evidence_or_risk",
        "dissent": False,
        "dissent_reason": "string | null",
        "material_risks": ["string"],
        "escalation_required": False,
    ...
    "public_policy_compliance_lead_agent": {
        "summary": "string",
        "compliance_assessment": "evidence_complete_for_review | evidence_incomplete",
        "evidence_basis": ["string"],
        "evidence_gaps": ["string"],
        "recommendation": "proceed_to_clo_internal_review | hold_for_evidence_or_risk",
        "dissent": False,
