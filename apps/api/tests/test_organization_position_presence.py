...
def test_presence_progresses_without_inventing_heartbeat(db_session: Session) -> None:
    ...
    missing = organization_position_presence_snapshot(db_session, work_item_id=work_item.id)
    ...
    executing = organization_position_presence_snapshot(db_session, work_item_id=work_item.id)
    ...
    inactive = organization_position_presence_snapshot(db_session, work_item_id=work_item.id)
