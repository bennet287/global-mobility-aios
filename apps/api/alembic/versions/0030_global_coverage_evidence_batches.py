...
def upgrade() -> None:
    ...
    for column in (
        ...
        op.create_index(
            op.f(f"ix_jurisdiction_coverage_evidence_batches_{column}"),
            "jurisdiction_coverage_evidence_batches",
            [column],
        )
    op.create_index(
        op.f("ix_jurisdiction_coverage_evidence_batches_batch_key"),
        "jurisdiction_coverage_evidence_batches",
        ["batch_key"],
        unique=True,
    )
    ...
    for column in (
        ...
        op.create_index(
            op.f(f"ix_jurisdiction_coverage_evidence_batch_items_{column}"),
            "jurisdiction_coverage_evidence_batch_items",
            [column],
        )
