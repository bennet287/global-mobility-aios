...
export const ownerNavigation: readonly OwnerNavigationItem[] = Object.freeze([
  ...
  { label: "History", icon: "history", href: "/cockpit/v2/history", enabled: true, description: "Canonical Activity replay, as-of state and explicit cursor comparison" },
]);
...
export const navigationCommands = Object.freeze([
  ...
  { label: "History", icon: "history" as const, href: "/cockpit/v2/history", description: "Inspect canonical Activity replay and as-of reconstruction" },
