...
**Date:** 2026-08-30
**Status:** ACTIVE CANONICAL RADAR / TRANCHE 1 R2 RESEARCH COMPLETE
...
V1.3.6 turns the radar from a growing technology inventory into a reproducible engineering research programme. It records common methods, exact upstream pins, weighted scorecards, hard blockers, AIOS-specific test scenarios and architecture outputs.
...
## 4. LangGraph truth reconciliation
...
The first possible R3 experiment is the isolated OpenFGA-vs-OPA authorization fixture. It remains unapproved until separately scheduled with an owner, exact pinned deployment, synthetic data, network/credential scope, expected decisions, artifacts, cleanup and acceptance criteria.

## 6. Subsequent tranche — not started

```text
sandbox/isolation comparison
Temporal/durable execution
memory architecture and Mem0/OpenViking
LangGraph/Agno orchestration fit
OpenTelemetry/Langfuse/Phoenix observability
final cross-tranche scorecard
```

No subsequent tranche begins automatically. Product necessity and `ROADMAP.md` remain scheduling authority.
